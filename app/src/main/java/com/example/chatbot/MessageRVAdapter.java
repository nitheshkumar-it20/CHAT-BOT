...
public class MessageRVAdapter<MessageModal> extends RecyclerView.Adapter {
    ...
    public MessageRVAdapter(ArrayList<MessageModal> messageModalArrayList, Context context) {
        this.messageModalArrayList = (ArrayList<MsgModal>) messageModalArrayList;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        MsgModal modal = (MsgModal) messageModalArrayList.get(position);
